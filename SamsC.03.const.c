...
/* Define a (symbolic) constant to convert a number of laps to miles */
#define LAPS_PER_MILE 4

/* Define a (literal) constant for the current year */
const int CURRENT_YEAR = 2017;  // isn't there a better way to do this?
